...
class NortherntrustdividendSpider(scrapy.Spider):
    name = 'northernTrustDividend'
    allowed_domains = ['https://www.dividendmax.com/united-states/nasdaq/financial-services/northern-trust-corp/dividends']
    start_urls = ['https://www.dividendmax.com/united-states/nasdaq/financial-services/northern-trust-corp/dividends/']

    def start_requests(self):
            urls = [
                'https://www.dividendmax.com/united-states/nasdaq/financial-services/northern-trust-corp/dividends/',
            ]
